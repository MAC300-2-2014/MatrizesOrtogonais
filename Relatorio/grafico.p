...
replot x**5-6.51600*x**4+6.49383*x**3-4.28765*x**2+2.01916*x-0.95088 title "Solução com variaçãoem A e b"
set title "Solução 5º grau com 15% de variação"
set xlabel " "
replot
...
replot x**4+6.81088*x**3-11.50075*x**2+1.59988*x-0.16756 title "Solução com variação em A e b"
...
replot x**3-11.28197*x**2+6.37680*x-0.00818 title "Solução com variação em A e b"
...
replot x**2+7.31438*x-4.75477 title "Solução com variação em A e b"
