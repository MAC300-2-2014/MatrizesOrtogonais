...
\begin{resumo}
Este relatório trata do desenvolvimento do algoritmo da decomposição QR por refletores, com implementação do posto incompleto e também de seu uso para resolução de ajuste de curvas pelo método dos mínimos quadrados. Por fim, todos os resultados foram condizentes com o esperado.
